      ...
      <Box>
        <Container>
          ...
          >
            ...
            <Typography fontSize={'1.5rem'} fontWeight={'550'} mt={3} mb={2} textTransform={'uppercase'}> Are you an introvert or an extrovert?</Typography>
            <Typography variant="subtitle1" style={{ textAlign: "center", fontWeight: "normal" }}>
